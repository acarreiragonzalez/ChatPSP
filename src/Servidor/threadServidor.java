 ...
 * Esta clase indica los mensajes tanto de error como de compilado de las llaves de encriptación, así como la insercción de usuarios y su eliminación.
 */
public class threadServidor extends Thread{
    ...
    public void run(){
        ...
        if(usu_duplicado == false){
            ...
            serv.mostrarEnConsola("Se ha eliminado un usuario");
